...
function inicio()
{
	var pikachu = new Pokemon("Pika!","Pikachu","Eléctrico",100,55, "/img/pokemon/pikachu.png");
	var bulbasaur = new Pokemon("Bulba!","Bulbasaur","Planta",90,50, "/img/pokemon/bulbasaur.jpg");
